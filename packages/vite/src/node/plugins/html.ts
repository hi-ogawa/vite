...
export function htmlInlineProxyPlugin(config: ResolvedConfig): RolldownPlugin {
 ...
 */
export function buildHtmlPlugin(config: ResolvedConfig): RolldownPlugin {
